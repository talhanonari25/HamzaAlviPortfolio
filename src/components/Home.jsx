    ...
    <div>
      ...
      <div>
        <p className="info">
          ...
          continuously seeking opportunities to expand my skill set and broaden
          my horizons. With an unquenchable thirst for knowledge, I am dedicated
          to embarking on a perpetual journey of learning and skill acquisition.
        </p>
      </div>
    </div>
  );
